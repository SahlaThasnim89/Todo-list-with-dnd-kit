  ...
  return (
    ...
    ">
       ...
       ">0</div>
        ...
        {editMode && <input className="bg-black
        focus:border-red-50
        border rounded
        outline-none
        px-2
        " 
        value={column.title} onChange={e=>updateColumn(column.id,e.target.value)} autoFocus onBlur={()=>{
            setEditMode(false);
        }}
        onKeyDown={e=>{
        ...
        <button onClick={()=>{deleteColumn(column.id)}} className="stroke-gray-500
        hover:stroke-white
